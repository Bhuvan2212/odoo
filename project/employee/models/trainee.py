...
class trainee(models.Model):
    _name = "employer.trainee"
    _description = "Employee trainee records"
    ...
    gender = fields.Selection([("male", "Male"), ("female", "Female"), ("others", "Others")], string="Gender",
                              tracking=True)
    fresher = fields.Boolean(string="fresher", tracking=True)
    ...
    status = fields.Selection([("male", "Male"), ("female", "Female"), ("others", "Others")],  index=True,
                              default='male')
    ...
    def create(self, vals_list):
        for vals in vals_list:
            vals['ref'] = self.env['ir.sequence'].next_by_code('employer.trainee')
        return super(trainee, self).create(vals_list)
